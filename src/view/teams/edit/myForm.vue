  ...
  <div class="content-container">
    <a-form :form="form" @submit="handleSubmit">
      ...
      <a-form-item v-bind="formItemLayout" label="团队名称">
        ...
        ]" :disabled="disabled" placeholder="请输入团队名称" />
      </a-form-item>
      <a-form-item v-bind="formItemLayout" label="团队联系人">
        ...
        ]" :disabled="disabled" placeholder="请输入团队联系人" />
      </a-form-item>
      ...
      <a-form-item v-bind="formItemLayout" label="团队管理员账号">
        <a-input v-decorator="[
          'username',
          {
              initialValue:formData.username,
            rules: [{
              required: true, message: '请输入团队管理员账号',
            }]
          }
        ]" :disabled="disabled" placeholder="请输入团队管理员账号" />
      </a-form-item>
